            ...
            <div class="  p-4">
                ...
                <div class="grid grid-cols-12 gap-x-2  ">
                    ...
                    <div class="space-y-2 col-span-12   ">
                        ...
                        <label for="status" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-200">
                            Category Options
                            <span class="block text-gray-500 text-sm">This is the actual order and current list of options </span>
                        </label> 
                        ...
                        @foreach ($category_options as $index => $category_option)
                            ...
                            {{-- @error('category_options.' . $index)
                                <div class="text-red-500 text-sm mt-1">Category option is required</div>
                            @enderror --}}
                        @endforeach
                    ...
                    <!-- Phone -->
                    <div class="space-y-2 col-span-12   ">
                    @error('category_options.*')
                        <p class="text-sm text-red-600 mt-2">Category option is required</p>
