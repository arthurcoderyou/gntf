            ...
            <div class="  p-4">
                ...
                <div class="grid grid-cols-12 gap-x-2  ">
                    ...
                    <div class="space-y-2 col-span-12 sm:col-span-6">
                        <label for="guardian_email" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-200">
                            Guardian Email
                        </label>

                        <input
                        autofocus autocomplete="guardian_email"
                        wire:model="guardian_email"
                        id="guardian_email" type="email"  class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="">
                    ...
                    <div class="space-y-2 col-span-12 sm:col-span-6">
                        <label for="gender" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-neutral-200">
                            Gender
                        </label>
