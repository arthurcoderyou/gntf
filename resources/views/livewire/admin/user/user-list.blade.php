            ...
            <div class="px-3 py-2 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                ...
                <div class="inline-flex gap-x-2">
                    ...
                    <div class="inline-flex items-center gap-x-2">
                        ...
                        <select wire:model.live="selected_gender" class="py-2 px-3 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                            <option value="">Sort Gender</option>
                            ...
                            <tr>
                                ...
                                <td class="size-auto whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        ...
                                        <div class="grow">
                                            <span class="block text-sm text-gray-500 dark:text-neutral-500">
                                                {{ !empty($user->guardian_email)  ? $user->guardian_email  : '' }}
                                            </span>
                                        </div>
                                        </div>
                                    </div>
                                ...
                                <td class="w-4 whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        @if( Auth::user()->can('user edit') ||  Auth::user()->hasRole('DSI God Admin'))
                                        <!-- edit -->
