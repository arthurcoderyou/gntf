                                                        ...
                                                        @foreach ($category->options as $option)
                                                            ...
                                                            <div class="col-span-12 grid sm:grid-cols-12 gap-x-2 mb-1">
                                                                ...
                                                                <div class="col-span-4">
                                                                    <label for="options_{{ $option->id }}" class="flex p-2 w-full bg-white border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                                                                        <input
                                                                        {{-- {{ count($double_partner_request) > 0 ? 'disabled' : '' }} --}}
                                                                ...
                                                                @if ($category->type === 'doubles')
                                                                    ...
                                                                    <div class="col-span-8">
                                                                        ...
                                                                        <!-- check if there are pending double partner request  -->
                                                                        ...
                                                                        {{-- @else 
                                                                            @if(!empty($double_partner_request) && count($double_partner_request) > 0)
                                                                                @foreach ($double_partner_request as $request) 
                                                                                
                                                                                    <div>
                                                                                        <label for="hs-trailing-multiple-add-on" class="sr-only">Multiple add-on</label>
                                                                                        <div class="flex rounded-lg shadow-sm">
                                                                                            <div title="Accept Partner Request"
                                                                                            class="cursor-pointer p-2 rounded-s-md inline-flex items-center min-w-fit border border-e-0 border-gray-200 bg-gray-50 dark:bg-neutral-700 dark:border-neutral-600"
                                                                                            ...
                                                                                            >
                                                                                                <span class="text-sm text-gray-500 dark:text-neutral-400"
                                                                                                    ...
                                                                                                    > 
                                                                                                    <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="#005eff" d="M313.4 32.9c26 5.2 42.9 30.5 37.7 56.5l-2.3 11.4c-5.3 26.7-15.1 52.1-28.8 75.2l144 0c26.5 0 48 21.5 48 48c0 18.5-10.5 34.6-25.9 42.6C497 275.4 504 288.9 504 304c0 23.4-16.8 42.9-38.9 47.1c4.4 7.3 6.9 15.8 6.9 24.9c0 21.3-13.9 39.4-33.1 45.6c.7 3.3 1.1 6.8 1.1 10.4c0 26.5-21.5 48-48 48l-97.5 0c-19 0-37.5-5.6-53.3-16.1l-38.5-25.7C176 420.4 160 390.4 160 358.3l0-38.3 0-48 0-24.9c0-29.2 13.3-56.7 36-75l7.4-5.9c26.5-21.2 44.6-51 51.2-84.2l2.3-11.4c5.2-26 30.5-42.9 56.5-37.7zM32 192l64 0c17.7 0 32 14.3 32 32l0 224c0 17.7-14.3 32-32 32l-64 0c-17.7 0-32-14.3-32-32L0 224c0-17.7 14.3-32 32-32z"/></svg>
                                                                                                </span>
                                                                                            </div>

                                                                                            
                                                                                            <div class="p-2 block w-full border-gray-200 shadow-sm  border-2 text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                                                                            ...
                                                                                            class="cursor-pointer p-2 inline-flex items-center min-w-fit rounded-e-md border border-s-0 border-gray-200 bg-gray-50 dark:bg-neutral-700 dark:border-neutral-600">
                                                                                                <span class="text-sm text-gray-500 dark:text-neutral-400">
                                                                                                    <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="#ff0019" d="M313.4 479.1c26-5.2 42.9-30.5 37.7-56.5l-2.3-11.4c-5.3-26.7-15.1-52.1-28.8-75.2l144 0c26.5 0 48-21.5 48-48c0-18.5-10.5-34.6-25.9-42.6C497 236.6 504 223.1 504 208c0-23.4-16.8-42.9-38.9-47.1c4.4-7.3 6.9-15.8 6.9-24.9c0-21.3-13.9-39.4-33.1-45.6c.7-3.3 1.1-6.8 1.1-10.4c0-26.5-21.5-48-48-48l-97.5 0c-19 0-37.5 5.6-53.3 16.1L202.7 73.8C176 91.6 160 121.6 160 153.7l0 38.3 0 48 0 24.9c0 29.2 13.3 56.7 36 75l7.4 5.9c26.5 21.2 44.6 51 51.2 84.2l2.3 11.4c5.2 26 30.5 42.9 56.5 37.7zM32 384l64 0c17.7 0 32-14.3 32-32l0-224c0-17.7-14.3-32-32-32L32 96C14.3 96 0 110.3 0 128L0 352c0 17.7 14.3 32 32 32z"/></svg>
                                                                                                </span>
                                                        ...
                                                        <div class="max-w-full text-wrap ">
                                                            <div class="px-2 py-2   text-wrap">
                                                                ...
                                                                <span class="text-sm text-gray-600 dark:text-neutral-400">
                                                                    ...
                                                                    {{-- <span class="text-gray-500">
                                                                        Selected Option ID : <span class="text-gntf_green-500">{{ $selected_option_id }}</span> 
                                                                    </span> 
                                                                    <hr> --}}
